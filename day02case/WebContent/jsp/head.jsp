...
<script type="text/javascript">
		//head.jsp页面加载完成之后,向服务器发送请求,查询商品分类,在导航栏中展示
		$(function(){
			//alert("哈哈");
			...
			$.post(url,params,function(data){
				...
				$("#cId").append("<li><a href='${pageContext.request.contextPath}/product?method=findProByPage&cid="+ele.cid+"&pageNumber=1'>"+ele.cname+"</a></li>");
				});
			},"json")
