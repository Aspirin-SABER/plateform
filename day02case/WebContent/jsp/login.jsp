...
font {
 ...
 <script type="text/javascript">
 	 $(function(){
 		$("#imgs").click(function(){
 			$("#imgs").src="${pageContext.request.contextPath}/code?t= "+new Date().getTime();
 			//alert(65456)
 		})
 	}) 
  onload=function(){
	...
	img.onclick=function(){
		img.src="${pageContext.request.contextPath}/code?t= "+new Date().getTime();
	}
...
<form class="form-horizontal" action="${pageContext.request.contextPath}/user" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="inputPassword3" placeholder="请输入验证码" name="sessionCode">
    </div>
    <div  class="col-sm-3">
      <img id="imgs" src="${pageContext.request.contextPath}/code"/>
    </div>
